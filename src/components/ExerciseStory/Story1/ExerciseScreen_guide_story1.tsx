...
export default class Exercise_guide_story extends React.Component<ScreenProps, ScreenState> {
  rafID?: number;
  ...
  async init(
    ...
    if (this.props.navigation.isFocused()) {
      ...
      //(수정)
      //(audio)띵! 카메라 조정이 완료되었습니다. 3초 후 운동이 시작됩니다. 띵 띵 띵 시작~!
      ...
      return (this.props.navigation.replace('exercise_story1_stage1'))
    }
  }
