...
export default class Story_tree2 extends React.Component<ScreenProps, ScreenState> {
  rafID?: number;
      ...
      if (seconds_30 == 0) {
        if (new Date().getTime() >= tree_miss_count + 20000) {
          ...
          if (this.props.navigation.isFocused()) {
            ...
            await soundObject4.loadAsync(require('../../../resource/story2/keyboard1.wav'));
            await soundObject4.playAsync()
            const soundObject5 = new Audio.Sound();
            await soundObject5.loadAsync(require('../../../resource/story2/keyboard1.wav'));
            await soundObject5.playAsync()
          }
          seconds_30 = 1;
        }
      }
        ...
        AsyncStorage.setItem('tree_miss2', tree_miss.toString(), () => { });
        ...
        await soundObject11.loadAsync(require('../../../resource/story2/story2_third_end.mp3'));
        await soundObject11.playAsync();
        await this.delay(8000)
        return (this.props.navigation.replace('Exercise_Story2_result'))
      }
